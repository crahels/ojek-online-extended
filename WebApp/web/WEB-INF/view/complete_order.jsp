...
<body>
    <div class="container" ng-app="completeOrderApp" ng-controller="completeOrder">
        ...
        <form action="complete_order.jsp" method="post" onsubmit="return validateCompleteOrder()">
            ...
            <input type="hidden" ng-model="picking_point" id="picking_point" name="picking_point" value=<% out.print(request.getParameter("picking_point")); %> >
            <input type="hidden" ng-model="destination" id="destination" name="destination" value=<% out.print(request.getParameter("destination")); %> >
            <input type="hidden" ng-model="driver_id" id="driver_id" name="driver_id" value=<% out.print(request.getParameter("driver_id")); %> >
            <div class="stars">
            ...
            <div class="form-comment">
                <textarea rows="2" cols ="72" id="comment" name="comment" ng-model="comment" placeholder="Your comment..."></textarea>
...
<script>
    ...
    app.controller('completeOrder', function($scope, $http, $location, $anchorScroll, $timeout) {
        ...
        $scope.endOrder = function() {
            $http.post($scope.endorder,{from: $scope.from, token: $scope.token})
